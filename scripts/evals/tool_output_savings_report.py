...
def redacted_report(report: dict[str, Any]) -> dict[str, Any]:
    allowed = {
        ...
        "handler_success_count",
        "invalid_argument_output_count",
        "task_success",
        "first_attempt_dispatch_success",
        "repair_activated",
        "repair_rules",
        "repair_rule_count",
        "candidate_work",
        ...
        "context_item_approx_bytes",
        "context_item_approx_count",
        "context_item_max_bytes",
        "context_items_below_1k_tokens",
    }
